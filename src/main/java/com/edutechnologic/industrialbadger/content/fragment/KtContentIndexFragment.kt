...
import com.edutechnologic.industrialbadger.content.groupie.ContentItem
import com.edutechnologic.industrialbadger.content.groupie.VolumeItem
...
class KtContentIndexFragment : ContentPresenterFragment(), ContentContract.SearchManager {
    companion object {
        @JvmStatic fun newInstance(): KtContentIndexFragment = KtContentIndexFragment()
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        content_recycler_view.apply {
            ...
            adapter = this@KtContentIndexFragment.adapter
        }
    }
